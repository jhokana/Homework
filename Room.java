...
public class Room 
{
	...
	{
		this.id = ((JSONANumberVariable)obj.getVariableForName("id")).getValue();
	...
	{
		for(int i = 0; i < this.theExits.length;)
		{
			if(this.theExits[i].getName().equals(theExits))
				this.thePlayer.displayToUser("Congrats");
